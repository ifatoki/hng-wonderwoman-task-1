...
hngId = "00487";    /// HNGi7 property
language = "JavaScript";   /// language property

var runScript =  function()   ///run function to add string together
{
  console.log( "Hello World, this is " + this.name + " with HNGi7 " + this.hngId +" using " + this.language + " for Stage 2 task.");  /// console. log with string combination
};  /// end of function
