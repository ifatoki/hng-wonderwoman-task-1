...
function testFileContent($string)
{
    ...
    // if (preg_match('/^Hello\sWorld[,|.|!]?\sthis\sis\s[a-zA-Z]{2,}\s[a-zA-Z]{2,}(\s[a-zA-Z]{2,})?\swith\sHNGi7\sID\s(HNG-\d{3,})\susing\s[a-zA-Z|#]{2,}\sfor\sstage\s2\stask\s(\.[_a-z0-9-]+)*@[a-z0-9-].?$/i', trim($string))) {
    //     return 'Pass';
    // }
